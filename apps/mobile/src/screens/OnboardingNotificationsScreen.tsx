...
const notificationsIllustration = require("../assets/onboarding/notifications.png");
...
function BenefitRow({ label }: { label: string }) {
  const styles = useOnboardingNotificationsStyles();
  return (
...
export function OnboardingNotificationsScreen({
  ...
  const content = (
    ...
    >
      {!embedded ? (
        <Stepper currentStep={4} style={styles.stepper} totalSteps={4} />
      ) : null}
      ...
      <View style={styles.illustrationWrap}>
        <Image
          ...
          resizeMode="contain"
          source={notificationsIllustration}
      ...
      <Text style={styles.subtitle}>
        See distance, club suggestions, and quick insights on your lock screen
      </Text>
...
function useOnboardingNotificationsStyles() {
